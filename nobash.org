...
to a stub executable written in language B.
...
In general I subscribe to the viewpoint [[https://nixos.org/~eelco/pubs/phd-thesis.pdf#page=178][described in section 7.1.1 of the Nix thesis]]
about static composition and dynamic linking.
