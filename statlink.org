...
A typical piece of software comes with an executable which starts up,
...
To statically link the configuration, we get rid of that hardcoded generic executable.
