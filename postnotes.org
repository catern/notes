...
deploying, running and monitoring services in a distributed system.
In particular, they [[http://catern.com/progsys.html][rely heavily on the static type system]] of Python 3,
and [[http://catern.com/config.html][express "configuration" with regular code]].
A key part of this is that regular function arguments
are used to express dependencies between services;
...
[[http://catern.com/supervisors.html][rather than delegating to a process supervisor or orchestrator service]].
Functionality is shared through [[http://catern.com/services.html][libraries rather than services]],
