...
** DONE add line count over time graph
   sure, sure

   need to finish this...
** DONE maybe turn on video camera
   lol no the laptop is unusable
* boopy feedback
** MARGINS!!!!
   ...
   blaaaah
   BLAAAH
   I think if people want it away from the edge of their screen,
   they can do that themselves.
* my own feedback
** DONE try it on laptop
   ...
   lol okay so the laptop has too small of a screen
   but it seems fine other than that.
** DONE need to set up proper website with shorturl
   on my homeserver

   oh actually I think it's fine as it is, just need to update it
** DONE update website with latest talk
** DONE maybe always have two windows open?
   then they won't complain

   yeah okay I can do this, I'm prepped for this
* feedback again
** DONE don't do the side-by-side thing for anything but the examples
** TODO make more abstract diagrams for the improve support thing
   maybe I'll just delete those building pictures, really...
** TODO explain the diagrams on the run the trading system page
   and make them bigger

   including the question marks inside

   explain: as in,
   mention that we have many different services with confusing dependencies

   aw screw it, I'll just delete those pictures too

   I hate pictures!
** DONE remove turnstile joke
