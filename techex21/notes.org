...
- Supports ~100 different daemons, across 8 teams.
- Always growing!

...
- Many teams producing many daemons
- C++, C, Java, Python, etc
- Configuration: properties, CSVs, YAML, env vars
- Protocols: JSON, Protocolgen, Protobuf, etc
...
These objects have all the info to use the service.

...

In TSS Integration,
production and tests build different environments,
...
- Usually, we'd have more components for more coverage

...
Add your daemons to TSS Integration,
